...
class FolderRenameOSErrorEdycjaFolderException(Exception):
    def __init__(self, stara_sciezka, nowa_sciezka, blad):
        super().__init__(
            f"Błąd systemowy przy zmianie nazwy folderu '{stara_sciezka}' -> '{nowa_sciezka}': {blad}"
        )
...
class ReplacePermissionDeniedZastapException(Exception):
    def __init__(self, stary_plik, nowy_plik):
        super().__init__(
            f"Brak uprawnień do zastąpienia pliku: {stary_plik} -> {nowy_plik}"
        )
...
class ReplaceOSErrorZastapException(Exception):
    def __init__(self, stary_plik, nowy_plik, blad):
        super().__init__(
            f"Błąd systemowy przy zastępowaniu pliku '{stary_plik}' -> '{nowy_plik}': {blad}"
        )
...
class FileResetOSErrorResetPlikException(Exception):
    def __init__(self, sciezka_pliku, blad):
        super().__init__(
            f"Błąd systemowy podczas resetowania pliku '{sciezka_pliku}': {blad}"
        )
...
class FileReadOSErrorResetPlikException(Exception):
    def __init__(self, sciezka_pliku, blad):
        super().__init__(
            f"Błąd systemowy podczas odczytu pliku '{sciezka_pliku}': {blad}"
        )
...
class UnsupportedFileExtensionOdczytajException(Exception):
    def __init__(self, rozszerzenie):
        super().__init__(
            f"Nieobsługiwane rozszerzenie pliku do odczytu: .{rozszerzenie}"
        )
...
class UnsupportedFileExtensionDopiszException(Exception):
    def __init__(self, rozszerzenie):
        super().__init__(
            f"Nieobsługiwane rozszerzenie pliku do dopisania: .{rozszerzenie}"
        )
...
class FileAppendOSErrorDopiszException(Exception):
    def __init__(self, sciezka_pliku, blad):
        super().__init__(
            f"Błąd systemowy podczas dopisywania do pliku '{sciezka_pliku}': {blad}"
        )
