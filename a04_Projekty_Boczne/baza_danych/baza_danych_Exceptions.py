...
class NoneValueException(BazaDanychSprawdzOtworz):
    def __init__(self, kolumna, wiersz):
        super().__init__(
            f"Wartość w kolumnie {kolumna} wiersz {wiersz} nie może być None"
        )
...
class UnsupportedValueTypeException(BazaDanychSprawdzOtworz):
    def __init__(self, typ, kolumna, wiersz):
        super().__init__(
            f"Niewspierany typ wartości {typ} w kolumnie {kolumna} wiersz {wiersz}"
        )
...
class DatabaseIntegrityFromSaveException(BazaDanychSprawdzZapisz):
    def __init__(self, original_msg):
        super().__init__(
            f"Naruszenie ograniczeń integralności bazy (unikalność, klucze obce): {original_msg}"
        )
...
class DatabaseOperationalFromSaveException(BazaDanychSprawdzZapisz):
    def __init__(self, original_msg):
        super().__init__(
            f"Błędy SQL podczas zapisu (np. błędne zapytania, brak tabel): {original_msg}"
        )
...
class DatabaseFileFromSaveException(BazaDanychSprawdzZapisz):
    def __init__(self, original_msg):
        super().__init__(
            f"Problemy z plikiem bazy (uszkodzenie, brak miejsca): {original_msg}"
        )
...
class InvalidColumnTupleStructureFromAddException(
    BazaDanychSprawdzDodajElementException
):
    def __init__(self, kolumna):
        super().__init__(
            f"Niepoprawna struktura klucza kolumny (oczekiwano tuple (int, str)): {kolumna}"
        )
...
class AutoGeneratedRowIdConflictFromAddException(
    BazaDanychSprawdzDodajElementException
):
    def __init__(self, wiersz_id):
        super().__init__(
            f"Konflikt ID wiersza wygenerowanego automatycznie: {wiersz_id}"
        )


class MissingRowIdWhenAutoDisabledFromAddException(
    BazaDanychSprawdzDodajElementException
):
    def __init__(self):
...
class InvalidRowKeyTypeFromAddException(BazaDanychSprawdzDodajElementException):
    def __init__(self, typ):
        super().__init__(
            f"Niepoprawny typ klucza wiersza (oczekiwano int lub str): {typ}"
        )


class InvalidAdditionElementNoneFromAddException(
    BazaDanychSprawdzDodajElementException
):
...
class NoDatabaseProvidedDodajPrzestrzenException(
    BazaDanychSprawdzDodajPrzestrzenException
):
    def __init__(self, msg):
        super().__init__(f"Brak dostępu do bazy danych: {msg}")


class InvalidColumnTupleStructureDodajPrzestrzenException(
    BazaDanychSprawdzDodajPrzestrzenException
):
    def __init__(self, kolumna):
        super().__init__(
...
class ColumnIdNotFoundDodajPrzestrzenException(
    BazaDanychSprawdzDodajPrzestrzenException
):
    def __init__(self, kolumna_id):
        super().__init__(f"Nie znaleziono kolumny o ID: {kolumna_id}")
...
class ColumnNameNotFoundDodajPrzestrzenException(
    BazaDanychSprawdzDodajPrzestrzenException
):
    def __init__(self, kolumna_nazwa):
        super().__init__(f"Nie znaleziono kolumny o nazwie: {kolumna_nazwa}")
...
class InvalidColumnTypeDodajPrzestrzenException(
    BazaDanychSprawdzDodajPrzestrzenException
):
    def __init__(self, typ):
        super().__init__(f"Niepoprawny typ kolumny (oczekiwano int lub str): {typ}")
...
class InvalidRowContainerTypeDodajPrzestrzenException(
    BazaDanychSprawdzDodajPrzestrzenException
):
    def __init__(self, typ):
        super().__init__(f"Niepoprawny typ kontenera wierszy (oczekiwano dict): {typ}")
...
class AutoGeneratedRowIdConflictDodajPrzestrzenException(
    BazaDanychSprawdzDodajPrzestrzenException
):
    def __init__(self, wiersz_id):
        super().__init__(
...
class MissingRowIdWhenAutoDisabledDodajPrzestrzenException(
    BazaDanychSprawdzDodajPrzestrzenException
):
    def __init__(self):
        super().__init__("Brak ID wiersza gdy autoWiersz jest wyłączone")
...
class InvalidRowIdInColumnDodajPrzestrzenException(
    BazaDanychSprawdzDodajPrzestrzenException
):
    def __init__(self, wiersz_id, kolumna):
        super().__init__(f"Niepoprawny ID wiersza {wiersz_id} w kolumnie {kolumna}")
...
class InvalidRowKeyTypeDodajPrzestrzenException(
    BazaDanychSprawdzDodajPrzestrzenException
):
    def __init__(self, typ):
        super().__init__(
...
class InvalidAdditionElementNoneDodajPrzestrzenException(
    BazaDanychSprawdzDodajPrzestrzenException
):
    def __init__(self, wartosc):
...
class InvalidRemovalNameTypeUsunException(BazadanychSprawdzUsunException):
    def __init__(self, typ):
        super().__init__(
            f"Niepoprawny typ nazwy do usunięcia (oczekiwano str, int lub tuple): {typ}"
        )
...
class InvalidElementKeyUsunException(BazadanychSprawdzUsunException):
    def __init__(self, wartosc):
        super().__init__(
            f"Nieprawidłowy klucz elementu do usunięcia (oczekiwano krotkę (kolumna, wiersz)): {wartosc}"
        )
...
class InvalidColumnTupleStructureUsunException(BazadanychSprawdzUsunException):
    def __init__(self, wartosc):
        super().__init__(
            f"Niepoprawna struktura klucza kolumny (oczekiwano tuple (int, str)): {wartosc}"
        )
...
class InvalidColumnTypeUsunException(BazadanychSprawdzUsunException):
    def __init__(self, wartosc):
        super().__init__(
            f"Niepoprawny typ klucza kolumny (oczekiwano int i str): {wartosc}"
        )
